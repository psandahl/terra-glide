...
{
public:
    static constexpr float FarPlane = 1100.0f;
    ...
    Environment() :
        ...
        m_fogColor({ Math::color(122), Math::color(122), Math::color(122) }),
    ...
    float fogIntensity() const noexcept
    {
    ...
    const glm::vec3& fogColor() const noexcept
    {
        return m_fogColor;
    }
